...
<head>
  ...
  <meta name="description" content="IDKoding.com Merupakan Situs Belajar Programming bahasa Indonesia terstruktur dan mudah.">
  <meta name="keywords" content="Laravel, CodeIgniter,tutorial laravel indonesia, laravel indonesia, belajar laravel, tutorial laravel,tutorial php indonesia, belajar php, tutorial php bahasa indonesia, javascript indonesia, jquery indonesia, vuejs indonesia, Yii2, Golang, Web Design, Web Development, UI UX Design, Android Development, Full-Stack Developer, Back-End Developer, Front-End Developer, ID Koding, IDKoding, IDKoding.com">
  ...
  <meta property="og:description" content="IDKoding.com Merupakan Situs Belajar Programming bahasa Indonesia yang terstruktur dan mudah dipelajari Seperti Laravel, Yii2, Codeigniter, GOlang, Javascript, dan lain-lain." />
      ...
      <nav class="site-nav">
        ...
        <div class="row align-items-center">
          <div class="col-12 col-sm-12 col-lg-12 site-navigation text-center">
            ...
            <a href="#" class="burger dark ml-auto site-menu-toggle js-menu-toggle d-block d-lg-none" data-toggle="collapse" data-target="#main-navbar">
              <span></span>
            </a>
          </div>
        </div>
